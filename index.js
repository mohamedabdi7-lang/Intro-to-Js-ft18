...
// Convert each Fahrenheit day to Celsius
...
// Convert each Celsius day to Fahrenheit
...
console.log("Total Temperature (F):", tot_temperature_in_fahrenheit);
console.log("Total Temperature (C):", tot_temperature_in_celsius);
